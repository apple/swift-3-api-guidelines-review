...
class PHAsset : PHObject {
  ...
  class func fetchAssets(withOptions options: PHFetchOptions?) -> PHFetchResult
  class func fetchAssets(withMediaType mediaType: PHAssetMediaType, options: PHFetchOptions?) -> PHFetchResult
