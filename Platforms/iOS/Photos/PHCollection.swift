...
class PHAssetCollection : PHCollection {
  ...
  class func transientAssetCollection(assetFetchResult fetchResult: PHFetchResult, title: String?) -> PHAssetCollection
  init()
}
@available(iOS 8.0, *)
class PHCollectionList : PHCollection {
  ...
  class func transientCollectionList(collectionsFetchResult fetchResult: PHFetchResult, title: String?) -> PHCollectionList
  init()
}
