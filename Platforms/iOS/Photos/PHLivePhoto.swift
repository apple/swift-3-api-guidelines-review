...
class PHLivePhoto : Object, Copying, SecureCoding {
  var size: CGSize { get }
  class func request(resourceFileURLs fileURLs: [URL], placeholderImage image: UIImage?, targetSize: CGSize, contentMode: PHImageContentMode = .`default`, resultHandler: (PHLivePhoto?, [Object : AnyObject]) -> Void) -> PHLivePhotoRequestID
