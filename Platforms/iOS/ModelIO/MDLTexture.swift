...
class MDLTexture : Object, MDLNamed {
  ...
  class func irradianceTextureCube(texture: MDLTexture, name: String?, dimensions: vector_int2) -> Self
  class func irradianceTextureCube(texture: MDLTexture, name: String?, dimensions: vector_int2, roughness: Float) -> Self
