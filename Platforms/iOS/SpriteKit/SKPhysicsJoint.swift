...
class SKPhysicsJointPin : SKPhysicsJoint {
  class func joint(bodyA bodyA: SKPhysicsBody, bodyB: SKPhysicsBody, anchor: CGPoint) -> SKPhysicsJointPin
...
class SKPhysicsJointLimit : SKPhysicsJoint {
  ...
  class func joint(bodyA bodyA: SKPhysicsBody, bodyB: SKPhysicsBody, anchorA: CGPoint, anchorB: CGPoint) -> SKPhysicsJointLimit
  init()
  init?(coder aDecoder: Coder)
}
