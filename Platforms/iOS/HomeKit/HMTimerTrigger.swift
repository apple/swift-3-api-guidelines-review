...
class HMTimerTrigger : HMTrigger {
  init(name name: String, fire fireDate: NSDate, timeZone timeZone: NSTimeZone?, recurrence recurrence: NSDateComponents?, recurrenceCalendar recurrenceCalendar: NSCalendar?)
  ...
  func updateFire(_ fireDate: NSDate, completionHandler completion: (NSError?) -> Void)
