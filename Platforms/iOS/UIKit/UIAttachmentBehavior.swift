...
class UIAttachmentBehavior : UIDynamicBehavior {
  ...
  @available(iOS 9.0, *)
  class func slidingAttachment(item1: UIDynamicItem, attachedTo item2: UIDynamicItem, attachmentAnchor point: CGPoint, axisOfTranslation axis: CGVector) -> Self
  @available(iOS 9.0, *)
  class func slidingAttachment(item: UIDynamicItem, attachmentAnchor point: CGPoint, axisOfTranslation axis: CGVector) -> Self
  @available(iOS 9.0, *)
  class func limitAttachment(item1: UIDynamicItem, offsetFromCenter offset1: UIOffset, attachedTo item2: UIDynamicItem, offsetFromCenter offset2: UIOffset) -> Self
  @available(iOS 9.0, *)
  class func fixedAttachment(item1: UIDynamicItem, attachedTo item2: UIDynamicItem, attachmentAnchor point: CGPoint) -> Self
  @available(iOS 9.0, *)
  class func pinAttachment(item1: UIDynamicItem, attachedTo item2: UIDynamicItem, attachmentAnchor point: CGPoint) -> Self
