...
class NSLayoutConstraint : Object {
  class func constraints(visualFormat format: String, options opts: NSLayoutFormatOptions = [], metrics: [String : AnyObject]?, views: [String : AnyObject]) -> [NSLayoutConstraint]
