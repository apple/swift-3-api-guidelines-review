...
extension DRFile {
  class func virtualFileWith(name name: String!, data: Data!) -> DRFile!
  class func virtualFileWith(name name: String!, dataProducer producer: AnyObject!) -> DRFile!
...
protocol DRFileDataProduction {
  ...
  func prepareFileFor(verification file: DRFile!) -> Bool
