...
@available(*, deprecated, renamed="SecKeychain")
typealias SecKeychainRef = SecKeychain
@available(*, deprecated, renamed="SecKeychainItem")
typealias SecKeychainItemRef = SecKeychainItem
class SecKeychainItem {
}
class SecKeychainSearch {
}
@available(*, deprecated, renamed="SecKeychainSearch")
...
@available(*, deprecated, renamed="SecTrustedApplication")
...
@available(*, deprecated, renamed="SecAccess")
...
@available(*, deprecated, renamed="SecACL")
...
@available(*, deprecated, renamed="SecPassword")
