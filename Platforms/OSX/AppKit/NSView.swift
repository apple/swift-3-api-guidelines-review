...
class NSView : NSResponder, NSAnimatablePropertyContainer, NSUserInterfaceItemIdentification, NSDraggingDestination, NSAppearanceCustomization, NSAccessibilityElementProtocol, NSAccessibility {
  ...
  func resizeSubviews(withOldSize oldSize: Size)
...
extension NSView {
  @available(OSX 10.7, *)
  func beginDraggingSession(withItems items: [NSDraggingItem], event: NSEvent, source: NSDraggingSource) -> NSDraggingSession
