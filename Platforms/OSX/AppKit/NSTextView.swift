...
extension NSTextView {
  func dragSelection(with event: NSEvent, offset mouseOffset: Size, slideBack: Bool) -> Bool
  func dragImageForSelection(with event: NSEvent, origin: PointPointer) -> NSImage?
