...
class NSResponder : Object, Coding {
  ...
  @available(OSX 10.5, *)
  func magnify(event: NSEvent)
  @available(OSX 10.5, *)
  func rotate(event: NSEvent)
  @available(OSX 10.5, *)
  func swipe(event: NSEvent)
  @available(OSX 10.5, *)
  func beginGesture(event: NSEvent)
  @available(OSX 10.5, *)
  func endGesture(event: NSEvent)
  @available(OSX 10.8, *)
  func smartMagnify(event: NSEvent)
  @available(OSX 10.6, *)
  func touchesBegan(event: NSEvent)
  @available(OSX 10.6, *)
  func touchesMoved(event: NSEvent)
  @available(OSX 10.6, *)
  func touchesEnded(event: NSEvent)
  @available(OSX 10.6, *)
  func touchesCancelled(event: NSEvent)
  @available(OSX 10.8, *)
  func quickLook(event: NSEvent)
  @available(OSX 10.10.3, *)
  func pressureChange(event: NSEvent)
