...
@available(OSX 10.5, *)
func CopySpeechProperty(chan: SpeechChannel, _ property: CFString, _ object: UnsafeMutablePointer<CFTypeRef?>) -> OSErr
@available(OSX 10.5, *)
func SetSpeechProperty(chan: SpeechChannel, _ property: CFString, _ object: CFTypeRef?) -> OSErr
@available(OSX 10.6, *)
