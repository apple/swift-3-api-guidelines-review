...
extension NSObject {
  ...
  @available(OSX 10.5, *)
  class func newScriptingObjectOf(_ objectClass: AnyClass, forValueForKey key: String, withContentsValue contentsValue: AnyObject?, properties properties: [String : AnyObject]) -> AnyObject?
  @available(OSX 10.5, *)
  func newScriptingObjectOf(_ objectClass: AnyClass, forValueForKey key: String, withContentsValue contentsValue: AnyObject?, properties properties: [String : AnyObject]) -> AnyObject?
