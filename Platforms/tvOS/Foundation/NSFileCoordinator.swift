...
class FileAccessIntent : Object {
  class func readingIntent(url: URL, options: FileCoordinatorReadingOptions = []) -> Self
  class func writingIntent(url: URL, options: FileCoordinatorWritingOptions = []) -> Self
...
class FileCoordinator : Object {
  ...
  @available(tvOS 8.0, *)
  func coordinateAccess(intents: [FileAccessIntent], queue: OperationQueue, byAccessor accessor: (Error?) -> Void)
