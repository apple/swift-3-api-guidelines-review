...
class Timer : Object {
  ...
  class func scheduledTimer(timeInterval ti: TimeInterval, invocation: Invocation, repeats yesOrNo: Bool) -> Timer
  ...
  class func scheduledTimer(timeInterval ti: TimeInterval, target aTarget: AnyObject, selector aSelector: Selector, userInfo: AnyObject?, repeats yesOrNo: Bool) -> Timer
