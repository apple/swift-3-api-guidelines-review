...
class WKInterfaceController : Object {
  ...
  func handleAction(withIdentifier identifier: String?, forLocalNotification localNotification: UILocalNotification)
  ...
  @available(watchOS 2.0, *)
  func presentMediaPlayerController(withURL URL: URL, options: [Object : AnyObject]? = [:], completion: (Bool, TimeInterval, Error?) -> Void)
  @available(watchOS 2.0, *)
  func dismissMediaPlayerController()
  @available(watchOS 2.0, *)
  func presentAudioRecorderController(withOutputURL URL: URL, preset: WKAudioRecorderPreset, options: [Object : AnyObject]? = [:], completion: (Bool, Error?) -> Void)
  @available(watchOS 2.0, *)
  ...
  @available(watchOS 2.0, *)
  func presentAddPassesController(withPasses passes: [AnyObject], completion: () -> Void)
  @available(watchOS 2.0, *)
  func dismissAddPassesController()
  func addMenuItem(withImage image: UIImage, title: String, action: Selector)
  func addMenuItem(withImageNamed imageName: String, title: String, action: Selector)
  func addMenuItem(withItemIcon itemIcon: WKMenuItemIcon, title: String, action: Selector)
