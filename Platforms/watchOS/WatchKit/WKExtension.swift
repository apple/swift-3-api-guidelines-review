...
protocol WKExtensionDelegate : ObjectProtocol {
  ...
  optional func handleAction(identifier identifier: String?, forLocalNotification localNotification: UILocalNotification)
  ...
  optional func handleAction(identifier identifier: String?, forLocalNotification localNotification: UILocalNotification, withResponseInfo responseInfo: [Object : AnyObject])
