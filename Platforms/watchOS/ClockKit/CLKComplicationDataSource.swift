...
protocol CLKComplicationDataSource : NSObjectProtocol {
  ...
  optional func getTimelineEntries(for complication: CLKComplication, before date: NSDate, limit: Int, withHandler handler: ([CLKComplicationTimelineEntry]?) -> Void)
  optional func getTimelineEntries(for complication: CLKComplication, after date: NSDate, limit: Int, withHandler handler: ([CLKComplicationTimelineEntry]?) -> Void)
