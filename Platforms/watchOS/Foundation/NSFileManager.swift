...
class FileManager : Object {
  ...
  func fileAttributes(atPath path: String, traverseLink yorn: Bool) -> [Object : AnyObject]?
  @available(watchOS, introduced=2.0, deprecated=2.0)
  ...
  @available(watchOS, introduced=2.0, deprecated=2.0)
  func fileSystemAttributes(atPath path: String) -> [Object : AnyObject]?
  @available(watchOS, introduced=2.0, deprecated=2.0)
  ...
  @available(watchOS, introduced=2.0, deprecated=2.0)
  func createDirectory(atPath path: String, attributes: [Object : AnyObject] = [:]) -> Bool
